...
export default function HomePage() {
    ...
    return (
        <>
            <h1>Logged in!</h1>
            <Link to="/devices" className="text-gray-600">Devices</Link> | 
            <Link className="text-gray-600" to="/nodes">Nodes</Link> | 
            <Link className="text-gray-600" to="/mqttMessages">MQTT Messages</Link>
