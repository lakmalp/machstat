...
export default function LoginForm(props) {
    ...
    const { currentUser, processing, errorCodes, errors, errorMessages, successMessages, login } = useService();
                ...
                <Card.Body>
                    <form>
                        <div className=''>
                            ...
                            <input ref={emailRef} disabled={processing} type="text" name="email" className="px-2 h-8 mt-1 border rounded-md w-full font-inter text-gray-500 focus:outline-1 outline-pink-400 focus:ring-2 ring-gray-200" autoFocus />
                            <Error name="email" messages={errorMessages} />
                        </div>
                        <div className='mt-6'>
                        ...
                        <div className='mt-6 flex justify-between items-center'>
                            <div className="flex items-center">
                                <input id="remember" type="checkbox" className="" disabled={processing} />
                        ...
                        <div className='mt-6 flex justify-center items-center'>
                            <Button caption="Login" name="singin" onClick={() => singin()} key="login" className="w-64 shadow px-6 h-8" processing={processing} disabled={processing} />
                        </div>
                        <hr className="mt-8" />
                        ...
                        <div className='flex justify-center items-center'>
                            <button disabled={processing} className="w-32 border text-center mr-2 py-1 rounded text-gray-500 hover:text-blue-500"><FontAwesomeIcon icon={faFacebook} className="text-xl" /></button>
                            <button disabled={processing} className="w-32 border text-center mr-2 py-1 rounded text-gray-500 hover:text-sky-400"><FontAwesomeIcon icon={faTwitter} className="text-xl" /></button>
                            <button disabled={processing} className="w-32 border text-center ml-2 py-1 rounded text-gray-500 hover:text-red-600"><FontAwesomeIcon icon={faGoogle} className="text-xl" /></button>
                        </div>
                        <div className='mt-6 flex justify-center items-center'>
