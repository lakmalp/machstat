    ...
    return (
        <div className={`flex items-center ${className}`}>
            <input
                ...
                className="w-full rounded py-0 text-left text-sm font-semibold border border-b1 px-1 border-gray-300 text-pink-700 h-7 focus:outline-pink-300 focus:outline-offset-0"
            />
